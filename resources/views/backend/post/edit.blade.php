...
@section('page-description','Ubah data post')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 page-title">Formulir Ubah Data Post</h4>
                    ...
                    <form action="{{ route('post.update',$post->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <txt-input name="judul_post"
                                           id="judul_post"
                                           required
                                           placeholder="Isikan nama post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <ta-input name="isi_post"
                                          id="isi_post"
                                          required placeholder="Tuliskan isi postingan"
                                          value="{{ $post->isi_post }}"
                                />
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <img-input
                                    ...
                                    name="thumbnail_post"
                                    v-bind:edit="true"
                                    v-bind:edit-obj="{{ json_encode($post) }}"
                                    v-bind:data="{{ json_encode(array($post->thumbnail_post)) }}"
                                    column="thumbnail_post"
                                >
                                </img-input>
                            </div>
                        </div>
