...
@section('page-description','Tambah data landmark ')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 page-title">Formulir Tambah Data Landmark</h4>
                    <p class="text-muted m-b-30">
                       Isikan data landmark, pastikan anda mengisi dengan teliti
                    </p>
                    <form action="{{ route('landmark.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <txt-input name="nama_landmark" id="nama_landmark" required placeholder="Isikan nama landmark"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="deskripsi_landmark" class="col-3">Deskripsi Landmark</label>
                            <div class="col-9">
                                <ta-input name="deskripsi_landmark" id="deskripsi_landmark" required placeholder="Isikan deskripsi selengkapnya tentang landmark"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="info_landmark" class="col-3">Info Landmark</label>
                            <div class="col-9">
                                <ta-input name="info_landmark" id="info_landmark" required placeholder="Isikan informasi selengkapnya tentang landmark"/>
                            </div>
                        </div>
                        <div class="form-group row">
